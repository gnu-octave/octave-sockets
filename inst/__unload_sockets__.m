...
## -*- texinfo -*-
## @deftypefn {} {} __unload_sockets__ ()
## Undocumented internal function of sockets package.
## @end deftypefn
        
## PKG_DEL: __unload_sockets__ ()

function __unload_sockets__ ()
  # on package unload, attempt to unload docs
  try
    pkg_dir = fileparts (fullfile (mfilename ("fullpath")));
    doc_file = fullfile (pkg_dir, "doc", "sockets.qch");
