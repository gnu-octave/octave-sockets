...
<dt class="deftypefn def-line" id="index-getsockopt"><span class="category-def">Loadable Function: </span><span><code class="def-type">[<var class="var">data</var>, <var class="var">status</var>] =</code> <strong class="def-name">getsockopt</strong> <code class="def-code-arguments">(<var class="var">s</var>, <var class="var">level</var>, <var class="var">optname</var>)</code><a class="copiable-link" href="#index-getsockopt"></a></span></dt>
