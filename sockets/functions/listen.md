...
<dt class="deftypefn def-line" id="index-listen"><span class="category-def">Loadable Function: </span><span><strong class="def-name">listen</strong> <code class="def-code-arguments">(<var class="var">s</var>, <var class="var">backlog</var>)</code><a class="copiable-link" href="#index-listen"></a></span></dt>
