...
<dt class="deftypefn def-line" id="index-setsockopt"><span class="category-def">Loadable Function: </span><span><code class="def-type"><var class="var">status</var> =</code> <strong class="def-name">setsockopt</strong> <code class="def-code-arguments">(<var class="var">s</var>, <var class="var">level</var>, <var class="var">optname</var>, <var class="var">optvalue</var>)</code><a class="copiable-link" href="#index-setsockopt"></a></span></dt>
