...
<dt class="deftypefn def-line" id="index-shutdown"><span class="category-def">Loadable Function: </span><span><strong class="def-name">shutdown</strong> <code class="def-code-arguments">(<var class="var">s</var>, <var class="var">how</var>)</code><a class="copiable-link" href="#index-shutdown"></a></span></dt>
